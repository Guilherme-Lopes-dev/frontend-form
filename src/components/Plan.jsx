      ...
      <div className='flex-col m-12 p-6 border-grey-700'>
        <div className='px-[10%] pt-[5%]'>
          ...
          <div className='flex w-[100%] justify-around pt-10	'>
            <div className='h-60 w-[30%] rounded-2xl border-4 
            hover:border-indigo-400 hover:bg-indigo-100	hover:cursor-pointer'
            ...
            <div className='h-60 w-[30%] rounded-2xl border-4	 hover:border-indigo-400 hover:bg-indigo-100 hover:cursor-pointer	'
            ...
            <div className='pl-[30%] bg-indigo-100 rounded-full h-[3rem]'>
              <div className='pt-3'>
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" value="" className="sr-only peer" checked={isYearly} onChange={handlePlanSelectionWithPrice} />
